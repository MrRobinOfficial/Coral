...
namespace Coral {
	...
	void HostInstance::LoadCoralFunctions()
	{
		...
		s_ManagedFunctions.IsTypeAbstractFptr = LoadCoralManagedFunctionPtr<IsTypeAbstractFn>(CORAL_STR("Coral.Managed.TypeInterface, Coral.Managed"), CORAL_STR("IsTypeAbstract"));
